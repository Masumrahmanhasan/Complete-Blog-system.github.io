                        ...
                        <div class="category">
                            <div class="display-table center-text">
                                <div class="display-table-cell">
                                    <a href="{{ route('cotegory.post', $category->slug) }}"><h3><b>{{ $category->name }}</b></h3></a>
                                </div>
                            </div>
                        </div>
...
<section class="blog-area section">
    <div class="container">
                ...
                <div class="card h-100">
                    <div class="single-post post-style-1">
                        ...
                        <div class="blog-image">
                            <img src="{{ asset('storage/post/'.$post->image) }}" alt="Blog Image">
                        </div>
        ...
        <a class="load-more-btn" href="{{route('post.index')}}"><b>All POSTS</b></a>
